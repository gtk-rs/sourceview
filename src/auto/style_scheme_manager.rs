...
pub trait StyleSchemeManagerExt {
    ...
    fn connect_property_scheme_ids_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_search_path_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<StyleSchemeManager> {
    ...
    f(&StyleSchemeManager::from_glib_none(this).downcast_unchecked())
}
