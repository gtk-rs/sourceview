...
pub trait PrintCompositorExt {
    ...
    fn connect_property_body_font_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_buffer_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_footer_font_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_header_font_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_highlight_syntax_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_line_numbers_font_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_n_pages_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_print_footer_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_print_header_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_print_line_numbers_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
...
where P: IsA<PrintCompositor> {
    ...
    f(&PrintCompositor::from_glib_none(this).downcast_unchecked())
}
