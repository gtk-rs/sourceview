...
impl<O: IsA<Gutter> + IsA<glib::object::Object>> GutterExt for O {
    ...
    fn get_property_view(&self) -> Option<View> {
        unsafe {
            ...
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <View as StaticType>::static_type().to_glib());
    ...
    fn get_property_window_type(&self) -> gtk::TextWindowType {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <gtk::TextWindowType as StaticType>::static_type().to_glib());
