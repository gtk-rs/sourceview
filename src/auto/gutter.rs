...
impl<O: IsA<Gutter>> GutterExt for O {
    ...
    fn get_window(&self) -> Option<gdk::Window> {
        unsafe {
            from_glib_none(gtk_source_sys::gtk_source_gutter_get_window(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_padding(&self, xpad: i32, ypad: i32) {
        unsafe {
            gtk_source_sys::gtk_source_gutter_set_padding(self.as_ref().to_glib_none().0, xpad, ypad);
        }
    }
...
unsafe extern "C" fn notify_xpad_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_source_sys::GtkSourceGutter, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<Gutter> {
    let f: &F = &*(f as *const F);
    f(&Gutter::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_ypad_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_source_sys::GtkSourceGutter, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<Gutter> {
    let f: &F = &*(f as *const F);
    f(&Gutter::from_glib_borrow(this).unsafe_cast())
}
