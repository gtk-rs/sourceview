...
<<<<<<< HEAD
    #[cfg(feature = "v3_10")]
    fn connect_property_at_word_boundaries_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_10")]
    fn connect_property_case_sensitive_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_10")]
    fn connect_property_regex_enabled_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_10")]
    fn connect_property_search_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_10")]
    fn connect_property_wrap_around_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
<<<<<<< HEAD
    f(&SearchSettings::from_glib_none(this).downcast_unchecked())
}
