...
unsafe extern "C" fn notify_description_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::GtkSourceStyleScheme, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<StyleScheme> {
    let f: &F = transmute(f);
    f(&StyleScheme::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_filename_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::GtkSourceStyleScheme, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<StyleScheme> {
    let f: &F = transmute(f);
    f(&StyleScheme::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_name_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::GtkSourceStyleScheme, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<StyleScheme> {
    let f: &F = transmute(f);
    f(&StyleScheme::from_glib_borrow(this).unsafe_cast())
}
