...
impl ToGlib for BackgroundPatternType {
    ...
    fn to_glib(&self) -> ffi::GtkSourceBackgroundPatternType {
        match *self {
            ...
            BackgroundPatternType::__Unknown(value) => unsafe{std::mem::transmute(value)}
        }
    }
}
...
impl<'a> FromValue<'a> for BackgroundPatternType {
    unsafe fn from_value(value: &Value) -> Self {
        from_glib(std::mem::transmute::<i32, ffi::GtkSourceBackgroundPatternType>(gobject_ffi::g_value_get_enum(value.to_glib_none().0)))
    }
}
...
impl ToGlib for ChangeCaseType {
    ...
    fn to_glib(&self) -> ffi::GtkSourceChangeCaseType {
        match *self {
            ...
            ChangeCaseType::__Unknown(value) => unsafe{std::mem::transmute(value)}
        }
    }
}
...
impl<'a> FromValue<'a> for ChangeCaseType {
    unsafe fn from_value(value: &Value) -> Self {
        from_glib(std::mem::transmute::<i32, ffi::GtkSourceChangeCaseType>(gobject_ffi::g_value_get_enum(value.to_glib_none().0)))
    }
}
...
impl ToGlib for CompressionType {
    ...
    fn to_glib(&self) -> ffi::GtkSourceCompressionType {
        match *self {
            ...
            CompressionType::__Unknown(value) => unsafe{std::mem::transmute(value)}
        }
    }
}
...
impl<'a> FromValue<'a> for CompressionType {
    unsafe fn from_value(value: &Value) -> Self {
        from_glib(std::mem::transmute::<i32, ffi::GtkSourceCompressionType>(gobject_ffi::g_value_get_enum(value.to_glib_none().0)))
    }
}
...
impl ToGlib for GutterRendererAlignmentMode {
    ...
    fn to_glib(&self) -> ffi::GtkSourceGutterRendererAlignmentMode {
        match *self {
            ...
            GutterRendererAlignmentMode::__Unknown(value) => unsafe{std::mem::transmute(value)}
        }
    }
}
...
impl<'a> FromValue<'a> for GutterRendererAlignmentMode {
    unsafe fn from_value(value: &Value) -> Self {
        from_glib(std::mem::transmute::<i32, ffi::GtkSourceGutterRendererAlignmentMode>(gobject_ffi::g_value_get_enum(value.to_glib_none().0)))
    }
}
...
impl ToGlib for NewlineType {
    ...
    fn to_glib(&self) -> ffi::GtkSourceNewlineType {
        match *self {
            ...
            NewlineType::__Unknown(value) => unsafe{std::mem::transmute(value)}
        }
    }
}
...
impl<'a> FromValue<'a> for NewlineType {
    unsafe fn from_value(value: &Value) -> Self {
        from_glib(std::mem::transmute::<i32, ffi::GtkSourceNewlineType>(gobject_ffi::g_value_get_enum(value.to_glib_none().0)))
    }
}
...
impl ToGlib for SmartHomeEndType {
    ...
    fn to_glib(&self) -> ffi::GtkSourceSmartHomeEndType {
        match *self {
            ...
            SmartHomeEndType::__Unknown(value) => unsafe{std::mem::transmute(value)}
        }
    }
}
...
impl<'a> FromValue<'a> for SmartHomeEndType {
    unsafe fn from_value(value: &Value) -> Self {
        from_glib(std::mem::transmute::<i32, ffi::GtkSourceSmartHomeEndType>(gobject_ffi::g_value_get_enum(value.to_glib_none().0)))
    }
}
