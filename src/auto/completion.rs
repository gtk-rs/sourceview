...
pub trait CompletionExt {
    ...
    fn create_context<'a, P: Into<Option<&'a mut gtk::TextIter>>>(&self, position: P) -> Option<CompletionContext>;
...
impl<O: IsA<Completion> + IsA<glib::object::Object>> CompletionExt for O {
    ...
    fn create_context<'a, P: Into<Option<&'a mut gtk::TextIter>>>(&self, position: P) -> Option<CompletionContext> {
        ...
        unsafe {
            from_glib_none(ffi::gtk_source_completion_create_context(self.to_glib_none().0, position.to_glib_none_mut().0))
        }
    }
