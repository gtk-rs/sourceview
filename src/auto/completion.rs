...
pub trait CompletionExt {
    ...
    fn connect_property_accelerators_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_auto_complete_delay_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_proposal_page_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_provider_page_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_remember_info_visibility_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_select_on_show_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_headers_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
