...
impl<O: IsA<Completion>> CompletionExt for O {
    ...
    fn move_window(&self, iter: &mut gtk::TextIter) {
        unsafe {
            gtk_source_sys::gtk_source_completion_move_window(self.as_ref().to_glib_none().0, iter.to_glib_none_mut().0);
        }
    }
    ...
    fn show<P: IsA<CompletionContext>>(&self, providers: &[CompletionProvider], context: &P) -> bool {
        unsafe {
            from_glib(gtk_source_sys::gtk_source_completion_show(self.as_ref().to_glib_none().0, providers.to_glib_none().0, context.as_ref().to_glib_none().0))
        }
    }
    ...
    fn emit_move_cursor(&self, step: gtk::ScrollStep, num: i32) {
        let _ = unsafe { glib::Object::from_glib_borrow(self.to_glib_none().0 as *mut gobject_sys::GObject).emit("move-cursor", &[&step, &num]).unwrap() };
    }
    ...
    fn emit_move_page(&self, step: gtk::ScrollStep, num: i32) {
        let _ = unsafe { glib::Object::from_glib_borrow(self.to_glib_none().0 as *mut gobject_sys::GObject).emit("move-page", &[&step, &num]).unwrap() };
    }
...
unsafe extern "C" fn move_cursor_trampoline<P, F: Fn(&P, gtk::ScrollStep, i32) + 'static>(this: *mut gtk_source_sys::GtkSourceCompletion, step: gtk_sys::GtkScrollStep, num: libc::c_int, f: glib_sys::gpointer)
where P: IsA<Completion> {
    let f: &F = &*(f as *const F);
    f(&Completion::from_glib_borrow(this).unsafe_cast(), from_glib(step), num)
}

unsafe extern "C" fn move_page_trampoline<P, F: Fn(&P, gtk::ScrollStep, i32) + 'static>(this: *mut gtk_source_sys::GtkSourceCompletion, step: gtk_sys::GtkScrollStep, num: libc::c_int, f: glib_sys::gpointer)
where P: IsA<Completion> {
    let f: &F = &*(f as *const F);
    f(&Completion::from_glib_borrow(this).unsafe_cast(), from_glib(step), num)
}
