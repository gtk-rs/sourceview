...
impl<O: IsA<MarkAttributes>> MarkAttributesExt for O {
    ...
    fn connect_query_tooltip_markup<F: Fn(&Self, &Mark) -> String + 'static>(
            ...
            P: IsA<MarkAttributes>,
        {
            ...
            f(
                &MarkAttributes::from_glib_borrow(this).unsafe_cast(),
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(
                    query_tooltip_markup_trampoline::<Self, F> as usize,
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_query_tooltip_text<F: Fn(&Self, &Mark) -> String + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(query_tooltip_text_trampoline::<Self, F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
