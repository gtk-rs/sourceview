...
pub trait ViewExt {
    ...
    fn connect_property_auto_indent_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_16")]
    fn connect_property_background_pattern_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_highlight_current_line_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_indent_on_tab_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_indent_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_insert_spaces_instead_of_tabs_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_right_margin_position_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_line_marks_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_line_numbers_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_right_margin_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_18")]
    fn connect_property_smart_backspace_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_smart_home_end_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_24")]
    fn connect_property_space_drawer_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_tab_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
