...
impl<O: IsA<View>> ViewExt for O {
    ...
    fn get_draw_spaces(&self) -> DrawSpacesFlags {
        unsafe {
            from_glib(gtk_source_sys::gtk_source_view_get_draw_spaces(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_draw_spaces(&self, flags: DrawSpacesFlags) {
        unsafe {
            gtk_source_sys::gtk_source_view_set_draw_spaces(self.as_ref().to_glib_none().0, flags.to_glib());
        }
    }
    ...
    fn emit_move_lines(&self, copy: bool, count: i32) {
        let _ = unsafe { glib::Object::from_glib_borrow(self.to_glib_none().0 as *mut gobject_sys::GObject).emit("move-lines", &[&copy, &count]).unwrap() };
    }
...
unsafe extern "C" fn move_lines_trampoline<P, F: Fn(&P, bool, i32) + 'static>(this: *mut gtk_source_sys::GtkSourceView, copy: glib_sys::gboolean, count: libc::c_int, f: glib_sys::gpointer)
where P: IsA<View> {
    let f: &F = &*(f as *const F);
...
unsafe extern "C" fn notify_draw_spaces_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_source_sys::GtkSourceView, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<View> {
    let f: &F = &*(f as *const F);
    f(&View::from_glib_borrow(this).unsafe_cast())
}
