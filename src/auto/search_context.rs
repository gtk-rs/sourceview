...
pub trait SearchContextExt {
    ...
    #[cfg(feature = "v3_10")]
    fn connect_property_highlight_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_16")]
    fn connect_property_match_style_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_10")]
    fn connect_property_occurrences_count_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_10")]
    fn connect_property_regex_error_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_10")]
    fn connect_property_settings_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<SearchContext> {
    ...
    f(&SearchContext::from_glib_none(this).downcast_unchecked())
}
